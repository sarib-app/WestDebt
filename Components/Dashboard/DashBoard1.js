...
<View style={styles.box}>
    <Image source={require("../../Images/Dashboard/Vectorsetting.png")}/>
            ...
            style={styles.second} >
                <View onPress={()=>navigation.navigate("DashBoard2")} style={styles.firstbox}>
<Image style={styles.profile} source={require("../../Images/Dashboard/DashBoardProfileImage.png")}/>
<View style={styles.inline}>
<Text onPress={()=>navigation.navigate("DashBoard2")} style={styles.welcome}>Welcome</Text>
...
<Text onPress={()=>navigation.navigate("DashBoard3")} style={styles.Debt}>List of My Debt</Text>
